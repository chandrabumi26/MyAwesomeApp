      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps="handled">
        <View className="flex-grow px-6 justify-center pt-10 pb-6">
          <View className="mb-10 w-full items-center">
            ...
            <Text className="text-slate-500 text-base">Sign Up to Join Us</Text>
          </View>
          ...
          <View className="bg-white rounded-3xl p-6 shadow-sm mb-8">
            ...
            <View className="mb-2">
              <Text className="text-slate-700 font-medium mb-2 pl-1">Confirm Password</Text>
              <TextInput
                className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-5 py-4 text-slate-800 text-base focus:border-blue-500 focus:bg-white"
                placeholder="Enter your password"
                placeholderTextColor="#94a3b8"
          ...
          <View className="flex-row justify-center mt-auto">
            ...
            <TouchableOpacity hitSlop={{top: 10, bottom:10, left:10, right:10}}>
              <Text className="text-blue-600 font-bold" onPress={(() => navigation.navigate('Login'))}>Sign In</Text>
            </TouchableOpacity>
          </View>
        </View>
      </ScrollView>
